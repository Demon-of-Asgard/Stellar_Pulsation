class Plot:
    ...
    def diuble_plot(self,filename):
        ...
        ax[0].plot(data[:, 0], data[:, 1], color=color["royal_blue"], linestyle="-", linewidth = lw)
        ...
        ax[1].plot(data[:, 0], data[:, 2], color=color["salmon"], linestyle="-", linewidth = lw)
